// frontend-mobile/src/utils/savedTaskListCode.js

// Esta string contém o código do componente SavedTaskList.js
// Ela é usada para a funcionalidade de "Ver Código" no mobile.
const savedTaskListRawCode = `
